...
////                    else
////                    {
////                        qDebug()<<"this tinght is no success";
...
//                if(Station == "A050new")
//                {
//                   qDebug()<<"this is A050new station";
//                }
//                else
//                {
//                    emit sendTighteningResult1(3,1);
...
//                                            emit  havedconnect(false);
    ...
    if(Station == "A050new")
    {
        if(GPareXMLFlag && (GsendEnableCount == GrecEnableCount))
        {
            GPareXMLFlag = false;
            GrecEnableCount = 0;
//            GsendEnableCount = 5;
...
//        if(channelData == 1)
//        {
//            emit sendTighteningResult1(5,5);
//        }
//        else if(channelData == 2)
//        {
//            emit sendTighteningResult2(5,5);
//        }
//    }
            if(channelData == 2)
            {
