...
//            {
//                qDebug() << "Get CurrentTime";
//                QNetworkReply *reply = manager->post(req3,json);
//                reply->ignoreSslErrors();
//                QTime t_time;
//                t_time.start();
...
//                                //将系统时间写入RTC
//                                system("hwclock -w &");
//                                qDebug()<<"GetCurrentTime success keycode"<<datetime;
//                            }
//                            else
//                                qDebug()<<"What's wrong keycode"<<bytes;
//                        }
//                        else
//                        {
//                            qDebug()<<"GetCurrentTime fail ";   //<<result["Error"].toString();
...
//                    QVariantMap result = parser.parse(bytes, &ok).toMap();
//                    if (!ok) {
//                        qDebug()<<"Set Andon An error occurred during parsing keycode"<<bytes;
//                    }
//                    else
//                    {
//                        if(!result["Result"].toBool())
