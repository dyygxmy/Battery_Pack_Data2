...
#define DYTEST0  //显示光标
#define DYTEST1  //测试请求托盘到位并手动扫码
#define DYTEST2  //测试扫码匹配失败的显示效果
#define DYTEST3  //测试EKS插拔记录存储
#define DYTEST4  //批头阀值提醒
#define DYTEST5  //PLC测试 S7300
